      ...
      <section className="py-6 border-b border-border/20">
        <div className="container mx-auto px-4">
          <div className="flex items-center gap-2 text-sm text-white/90">
            ...
            <span className="text-white/90 font-medium">Questions Importantes des Victimes</span>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-16 md:py-24 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center space-y-6 animate-fade-in">
            ...
            <h1 className="text-4xl md:text-6xl font-libre bakerville font-bold text-white/90 leading-tight">
            ...
            <div>
                    ...
                    >
                      <AccordionTrigger className="px-6 py-5 text-left hover:no-underline group">
                        <div className="flex items-start gap-4 pr-4 w-full">
                          ...
                          <span className="text-lg font-medium text-white/90 group-hover:text-[#E02B2B] transition-colors text-left">
                            {item.question}
                          </span>
                        </div>
                      </AccordionTrigger>
              ...
              {filteredFaqItems.length === 0 && (
                <div className="text-center py-12">
                  <HelpCircle className="h-16 w-16 text-white/90/50 mx-auto mb-4" />
            ...
            <div className="space-y-6">
              ...
              <div className="glass-card border border-[#E02B2B]/20 rounded-2xl p-6 sticky top-24 space-y-4">
                ...
                <div className="pt-2 space-y-3">
                  ...
                  <Link
                    to="/"
                    className="block w-full border border-border/50 hover:border-[#E02B2B]/50 text-white/90 font-medium py-3 px-4 rounded-xl transition-all duration-300 text-center hover:bg-[#E02B2B]/5"
                  >
                    Retour à l'accueil
                  </Link>
                </div>
                ...
                <div className="pt-4 border-t border-border/20">
                  ...
                  <p className="text-xs text-white/90/70">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
              ...
              <Link
                to="/"
                className="inline-flex items-center gap-2 border border-border/50 hover:border-[#E02B2B]/30 text-white/90 font-medium py-4 px-8 rounded-xl transition-all duration-300 hover:bg-[#E02B2B]/4 justify-center"
              >
      ...
      <section className="py-8 border-t border-border/10">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <p className="text-sm text-white/90/70 italic">
