        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <div className="mb-12">
            <div className="flex items-center gap-4 mb-4">
              ...
              <h1 className="text-4xl md:text-5xl font-bold font-libre bakerville text-white/90">
                Conditions d'Utilisation
              </h1>
            </div>
            <p className="text-white/90 text-lg">
              Règles d'usage du site Lema Clinic Truth
            </p>
          </div>
          ...
          <div className="mb-12 bg-primary-red/10 border border-primary-red/30 rounded-lg p-6">
            <p className="text-white/90 leading-relaxed">
              En accédant et en utilisant le site Lema Clinic Truth, vous acceptez de vous conformer aux présentes conditions d'utilisation. Si vous n'acceptez pas ces conditions, veuillez ne pas utiliser ce site.
            </p>
          </div>
          ...
          <div className="space-y-12">
            ...
            <section>
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-2xl font-bold text-white/90">1. Objet du site</h2>
              </div>
              <div className="bg-card/50 backdrop-blur-sm border border-border rounded-lg p-6 space-y-4">
                <p className="text-white/90">
                  Le site Lema Clinic Truth a pour mission de :
                </p>
            ...
            <section>
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-2xl font-bold text-white/90">2. Accès au site</h2>
              </div>
              <div className="bg-card/50 backdrop-blur-sm border border-border rounded-lg p-6 space-y-4">
                <p className="text-white/90">
                  L'accès au site est gratuit et ouvert à tous. Cependant, Lema Clinic Truth se réserve le droit de :
                </p>
                <ul className="list-disc list-inside text-white/90 space-y-2 ml-4">
            ...
            <section>
              <div className="flex items-center gap-3 mb-4">
                <CheckCircle className="h-6 w-6 text-primary-red" />
                <h2 className="text-2xl font-bold text-white/90">3. Utilisation acceptable du site</h2>
              </div>
              <div className="bg-card/50 backdrop-blur-sm border border-border rounded-lg p-6 space-y-4">
            ...
            <section>
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-2xl font-bold text-white/90">4. Comportements interdits</h2>
              </div>
              <div className="bg-card/50 backdrop-blur-sm border border-border rounded-lg p-6 space-y-4">
                <p className="text-white/90 font-semibold">
            ...
            <section>
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-2xl font-bold text-white/90">5. Soumission de témoignages</h2>
              </div>
              <div className="bg-card/50 backdrop-blur-sm border border-border rounded-lg p-6 space-y-4">
                <p className="text-white/90">
                ...
                <ul className="list-disc list-inside text-white/90 space-y-2 ml-4">
                  ...
                  <li>Autorisez Lema Clinic Truth à utiliser votre témoignage dans le cadre de sa mission (de manière anonyme ou pseudonyme si demandé)</li>
            ...
            <section>
              <div className="flex items-center gap-3 mb-4">
                <Shield className="h-6 w-6 text-primary-red" />
                <h2 className="text-2xl font-bold text-white/90">6. Propriété intellectuelle</h2>
              </div>
              <div className="bg-card/50 backdrop-blur-sm border border-border rounded-lg p-6 space-y-4">
                <p className="text-white/90">
                  Tous les éléments du site (textes, images, logos, design, structure) sont protégés par le droit d'auteur et appartiennent à Lema Clinic Truth ou à leurs auteurs respectifs.
                </p>
                <p className="text-white/90">
                ...
                <p className="text-white/90">
                  Les témoignages publiés restent la propriété de leurs auteurs, qui accordent à Lema Clinic Truth une licence d'utilisation dans le cadre de sa mission.
                </p>
              </div>
            </section>
            ...
            <section>
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-2xl font-bold text-white/90">7. Limitation de responsabilité</h2>
              </div>
              <div className="bg-card/50 backdrop-blur-sm border border-border rounded-lg p-6 space-y-4">
                <p className="text-white/90 font-semibold mb-2">
                  Lema Clinic Truth décline toute responsabilité concernant :
                </p>
                <ul className="list-disc list-inside text-white/90 space-y-2 ml-4">
            ...
            <section>
              <div className="flex items-center gap-3 mb-4">
                <FileText className="h-6 w-6 text-primary-red" />
                <h2 className="text-2xl font-bold text-white/90">8. Liens hypertextes</h2>
              </div>
              <div className="bg-card/50 backdrop-blur-sm border border-border rounded-lg p-6 space-y-4">
                <p className="text-white/90">
                  Le site peut contenir des liens vers des sites externes. Lema Clinic Truth n'exerce aucun contrôle sur ces sites et n'est pas responsable de leur contenu, de leurs pratiques de confidentialité ou de leurs conditions d'utilisation.
                </p>
                <p className="text-white/90">
            ...
            <section>
              <div className="flex items-center gap-3 mb-4">
                <CheckCircle className="h-6 w-6 text-primary-red" />
                <h2 className="text-2xl font-bold text-white/90">9. Modification des conditions</h2>
              </div>
              <div className="bg-card/50 backdrop-blur-sm border border-border rounded-lg p-6 space-y-4">
                <p className="text-white/90">
                  Lema Clinic Truth se réserve le droit de modifier les présentes conditions d'utilisation à tout moment. Les modifications entrent en vigueur dès leur publication sur le site.
                </p>
                <p className="text-white/90">
            ...
            <section>
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-2xl font-bold text-white/90">10. Droit applicable et juridiction</h2>
              </div>
              <div className="bg-card/50 backdrop-blur-sm border border-border rounded-lg p-6 space-y-4">
                <p className="text-white/90">
            ...
            <section>
              <div className="flex items-center gap-3 mb-4">
                <FileText className="h-6 w-6 text-primary-red" />
                <h2 className="text-2xl font-bold text-white/90">11. Contact</h2>
              </div>
              <div className="bg-card/50 backdrop-blur-sm border border-border rounded-lg p-6 space-y-4">
                <p className="text-white/90">
                ...
                <div className="ml-4 space-y-2 text-white/90">
                  <p><span className="font-semibold text-white/90">Email :</span> contact@lemaclinic-truth.com</p>
                  <p><span className="font-semibold text-white/90">Site web :</span> www.lemaclinic-truth.com</p>
                </div>
              </div>
            </section>
